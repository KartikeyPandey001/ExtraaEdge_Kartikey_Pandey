using MobileSalesExtraedgeassignment.Data;
...
using MobileSalesExtraedgeassignment.Service;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "MobileSalesExtraaEdgeAssignment", Version = "v1" });
...
app.MapControllers();
app.UseSwagger();
app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "MobileSalesExtraaEdgeAssignment v1"));
